...
public class pantry extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        picture.setImageResource(R.drawable.unlabelled_pantry);
        ...
        Boolean Rate_text = mPreferences.getBoolean(PANTRY,false);
        favon = Rate_text;
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(pantry.this, newtabbed.class);
        ...
        Favourite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!favon) {
                    Favourite.setImageResource(R.drawable.redheart);
                    favon = true;
                    Toast.makeText(pantry.this, "Added to Favourites!", Toast.LENGTH_SHORT).show();
                } else {
                    Favourite.setImageResource(R.drawable.emptyheart);
                    favon = false;
                    Toast.makeText(pantry.this, "Removed from Favourites!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(buildURL(getText(R.string.pantry_id).toString())));
                startActivity(intent);
            }
        });
    ...
    protected void onPause() {
        ...
        preferencesEditor.putBoolean(PANTRY, favon);
