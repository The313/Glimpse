...
public class soccer_court extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.soccer_court);
        ...
        picture.setImageResource(R.drawable.unlabelled_soccer_court);
        ...
        Boolean Rate_text = mPreferences.getBoolean(SOCCERCOURT,false);
        favon = Rate_text;
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(soccer_court.this, newtabbed.class);
        ...
        Favourite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!favon) {
                    Favourite.setImageResource(R.drawable.redheart);
                    favon = true;
                    Toast.makeText(soccer_court.this, "Added to Favourites!", Toast.LENGTH_SHORT).show();
                } else {
                    Favourite.setImageResource(R.drawable.emptyheart);
                    favon = false;
                    Toast.makeText(soccer_court.this, "Removed from Favourites!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(buildURL(getText(R.string.streetSoccer_id).toString())));
                startActivity(intent);
            }
        });
    ...
    protected void onPause() {
        ...
        preferencesEditor.putBoolean(SOCCERCOURT, favon);
