...
public class rock_climbing_wall extends AppCompatActivity{
    ...
    Double percentage;
    ImageButton map;
    public final Double MAXIMUM_CAPACITY = 10.0;
    ...
    String name = "Rock Climbing Wall";
    String lastupdated = "Last Updated at: ";
    String location = "57 Changi South Ave 1";
    String rates = "Free admission";
    String phonenumber = "+65 64998927";
    String subname = "Indoor Sports Hall 1";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rock_climbing_wall);
        ...
        picture.setImageResource(R.drawable.unlabelled_rock_climbing_wall);
        ...
        Boolean Rate_text = mPreferences.getBoolean(ROCKWALL,false);
        favon = Rate_text;
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(rock_climbing_wall.this, newtabbed.class);
        ...
        Favourite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!favon) {
                    Favourite.setImageResource(R.drawable.redheart);
                    favon = true;
                    Toast.makeText(rock_climbing_wall.this, "Added to Favourites!", Toast.LENGTH_SHORT).show();
                } else {
                    Favourite.setImageResource(R.drawable.emptyheart);
                    favon = false;
                    Toast.makeText(rock_climbing_wall.this, "Removed from Favourites!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(buildURL(getText(R.string.wallClimb_id).toString())));
                startActivity(intent);
            }
        });
    ...
    protected void onPause() {
        ...
        preferencesEditor.putBoolean(ROCKWALL, favon);
