    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(meeting_room1.this, newtabbed.class);
        ...
        Favourite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!favon) {
                    Favourite.setImageResource(R.drawable.redheart);
                    favon = true;
                    Toast.makeText(meeting_room1.this, "Added to Favourites!", Toast.LENGTH_SHORT).show();
                } else {
                    Favourite.setImageResource(R.drawable.emptyheart);
                    favon = false;
                    Toast.makeText(meeting_room1.this, "Removed from Favourites!", Toast.LENGTH_SHORT).show();
                }
            }
        });
