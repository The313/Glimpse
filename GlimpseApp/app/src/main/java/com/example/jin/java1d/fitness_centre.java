...
public class fitness_centre extends AppCompatActivity{
    ...
    Double percentage;
    ImageButton map;
    public final Double MAXIMUM_CAPACITY = 20.0;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fitness_centre);
        ...
        picture.setImageResource(R.drawable.unlabelled_fitness_centre);
        ...
        Boolean Rate_text = mPreferences.getBoolean(FITNESSCENTRE,false);
        favon = Rate_text;
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(fitness_centre.this, newtabbed.class);
        ...
        Favourite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!favon) {
                    Favourite.setImageResource(R.drawable.redheart);
                    favon = true;
                    Toast.makeText(fitness_centre.this, "Added to Favourites!", Toast.LENGTH_SHORT).show();
                } else {
                    Favourite.setImageResource(R.drawable.emptyheart);
                    favon = false;
                    Toast.makeText(fitness_centre.this, "Removed from Favourites!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(buildURL(getText(R.string.gym_id).toString())));
                startActivity(intent);
            }
        });
    ...
    protected void onPause() {
        ...
        preferencesEditor.putBoolean(FITNESSCENTRE, favon);
